...
const KEY_APPOINTMENT_DATE: &str = "Sales Appt Date";
...
const KEY_LOSS_DATE: &str = "Job Lost Date (Lost Status)";
...
pub struct JobAnalysis {
    ...
    pub last_update_milestone: Milestone,
}
        ...
        return (
            AnalyzedJob {
                analysis: Some(JobAnalysis {
                    ...
                    last_update_milestone: current_milestone,
                }),
                job,
            },
            errors,
            ...
            (
                AnalyzedJob {
                    ...
                    analysis: Some(JobAnalysis {
                        ...
                        timestamps: vec![None],
                        loss_timestamp: None,
                        last_update_milestone: Milestone::LeadAcquired,
                    }),
                },
                vec![],
            )
            ...
            (
                AnalyzedJob {
                    ...
                    analysis: Some(JobAnalysis {
                        ...
                        loss_timestamp: None,
                        last_update_milestone: Milestone::AppointmentMade,
                    }),
                },
                vec![],
            )
            ...
            (
                AnalyzedJob {
                    ...
                    analysis: Some(JobAnalysis {
                        ...
                        loss_timestamp: None,
                        last_update_milestone: Milestone::ContingencySigned,
                    }),
                },
                vec![],
            )
            ...
            (
                AnalyzedJob {
                    ...
                    analysis: Some(JobAnalysis {
                        ...
                        loss_timestamp: None,
                        last_update_milestone: Milestone::ContractSigned,
                    }),
                },
                vec![],
            )
